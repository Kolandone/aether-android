...
// ============================================================================
// Aether FFI declarations (from libaether.so)
// These functions are exported by the Rust cdylib build.
// If the binary is built as a standalone executable (not cdylib), these
// symbols won't exist and JNI calls will fail gracefully.
// ============================================================================
extern "C" {
...
// ============================================================================
// Global state for VPN socket protection callback
// ============================================================================
namespace {
JavaVM* g_vm = nullptr;
...
// ============================================================================
// JNI Methods — called from NativeCore.kt
// ============================================================================

extern "C" JNIEXPORT jint JNICALL
Java_com_aether_app_core_NativeCore_nativePrepare(JNIEnv* env, jobject, jstring config) {
    const auto config_text = copy_jstring(env, config);
    if (config_text.empty()) return -1;
    return aether_prepare_json(config_text.c_str());
}

extern "C" JNIEXPORT jstring JNICALL
Java_com_aether_app_core_NativeCore_nativeLastResult(JNIEnv* env, jobject) {
    return last_string(env, aether_last_result());
}

extern "C" JNIEXPORT jint JNICALL
Java_com_aether_app_core_NativeCore_nativeStart(JNIEnv* env, jobject, jstring config, jint tun_fd) {
    const auto config_text = copy_jstring(env, config);
    if (config_text.empty()) return -1;
...
extern "C" JNIEXPORT jint JNICALL
Java_com_aether_app_core_NativeCore_nativeStartProxy(JNIEnv* env, jobject, jstring config) {
    const auto config_text = copy_jstring(env, config);
    if (config_text.empty()) return -1;
...
extern "C" JNIEXPORT jint JNICALL
Java_com_aether_app_core_NativeCore_nativeStop(JNIEnv*, jobject) {
    return aether_stop();
}

extern "C" JNIEXPORT jboolean JNICALL
Java_com_aether_app_core_NativeCore_nativeIsRunning(JNIEnv*, jobject) {
    return aether_is_running() != 0;
}

extern "C" JNIEXPORT jboolean JNICALL
Java_com_aether_app_core_NativeCore_nativeIsReady(JNIEnv*, jobject) {
    return aether_is_ready() != 0;
}

extern "C" JNIEXPORT jstring JNICALL
Java_com_aether_app_core_NativeCore_nativeLastError(JNIEnv* env, jobject) {
    return last_string(env, aether_last_error());
}

extern "C" JNIEXPORT jstring JNICALL
Java_com_aether_app_core_NativeCore_nativeLastLog(JNIEnv* env, jobject) {
    return last_string(env, aether_last_log());
}

extern "C" JNIEXPORT void JNICALL
Java_com_aether_app_core_NativeCore_nativeAttach(JNIEnv* env, jobject, jobject service) {
    std::lock_guard<std::mutex> lock(g_service_mutex);
...
extern "C" JNIEXPORT void JNICALL
Java_com_aether_app_core_NativeCore_nativeDetach(JNIEnv* env, jobject) {
    std::lock_guard<std::mutex> lock(g_service_mutex);
